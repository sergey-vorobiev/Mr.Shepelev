	...
	<div class="main-panel">
		...
		<div id="addTrack-form" class="main-func">
			<form method="post" class="addTrack-form">
				...
				<label for="name">Ремикс на: </label>
				<input type="text" placeholder="Алимханов А.& А.Дрюня" name="remix_on" required>
	        	...
	        	<input type="submit" name="addRemix" value="Добавить трек" class="button-form-addTrack">
			</form>	
		</div>
	</div>
';

if(isset($_POST['addRemix'])){
	
	$remix_on = $_POST['remix_on'];
	$name = $_POST['name'];
	$autor = $_POST['autor'];
	$genre = $_POST['genre'];
	...
	$file = "music-pages/remixes/".$vowels.".php";

	addRemix($link, $remix_on, $name, $autor, $genre, $name_music_in_folder, $duration, $img_album, $data, $file);
	
	include("app/include/add_new_page_remixes.php");
